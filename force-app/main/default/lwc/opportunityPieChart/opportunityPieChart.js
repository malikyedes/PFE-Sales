...
export default class OpportunityPieChart extends LightningElement {
  ...
  renderedCallback() {
    ...
    if(!this.loadingInitialized) {
      ...
      */
      Promise.all([
        loadScript(this, D3 + '/d3/d3.min.js?t='+new Date().getTime()),
        loadScript(this, C3 + '/c3/c3-0.7.20/c3.min.js?t='+new Date().getTime()),
        loadStyle(this, C3 + '/c3/c3-0.7.20/c3.min.css?t='+new Date().getTime()),
      ])
      .then(() => {
        this.librariesLoaded = true;
